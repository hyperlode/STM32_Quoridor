...
# target
######################################
TARGET = STM32F407_discoveryboard_ToolchainTest
...
GCC_PATH="E:/TOOLS/PROGRAMMING/GNU ARM EMBEDDED TOOLCHAIN/10 2020-Q4-MAJOR/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"E:/TOOLS/PROGRAMMING/STM32 TOOLCHAIN/OPENOCD-20210729/OPENOCD-20210729-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"E:/TOOLS/PROGRAMMING/STM32 TOOLCHAIN/OPENOCD-20210729/OPENOCD-20210729-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f4x mass_erase 0; exit"
